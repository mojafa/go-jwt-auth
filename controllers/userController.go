...
import (
	...
	helper "github.com/mojafa/go-jwt-auth/helper"
...
func Login() gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		helper.GenerateAllTokens(*foundUser.Email, *foundUser.FirstName, *foundUser.LastName, *foundUser.UserType, foundUser.UserId)
